...
//  MessagesExtension
//
//  Created by MobileDeveloper89 on 17/07/16.
...
//        consContentW.constant = self.view.frame.size.width
        ...
        let tapGestureItem = UITapGestureRecognizer(target: self, action: #selector(onClickScrollItem(_:)))
        ...
        for i in 0...10
        {
            ...
            if i < 3
            {
                imgView.frame = CGRect(x: CGFloat( 35 * (i + 1) ) + sizeSticker.width * CGFloat( i ),
                                       y: CGFloat( 5 * (i/3 + 1) ) + sizeSticker.width * CGFloat( i/3 ),
            ...
            else
            {
                imgView.frame = CGRect(x: CGFloat( 35 * (i%3 + 1) ) + sizeSticker.width * CGFloat( i%3),
                                       y: CGFloat( 35 * (i/3 + 1) ) + sizeSticker.width * CGFloat( i/3 ),
                                       width: sizeSticker.width,
                                       height: sizeSticker.height)
            }
